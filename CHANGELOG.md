...
- **品牌主题统一**：安装看板、detached 启动看板与状态看板规范统一为 iLongRun 金黄色主题、右侧开口框，并在支持 ANSI 的终端里为 `iLongRun` 标题启用静态渐变
...
- **共享终端主题 helper**：新增 `_ilongrun_terminal_theme.py`，收敛金黄色品牌色、开口框、广告语等号框与标题渐变逻辑
