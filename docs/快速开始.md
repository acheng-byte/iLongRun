...
- build workstream 必须走 microcycle
- finalize 前必须有 fresh evidence
- recovery 前必须先写 root cause record
- skills 本身可以用 lint 检查 frontmatter / section / cross-reference
